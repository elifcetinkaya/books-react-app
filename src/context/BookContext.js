...
// - Başlangı. değeri verip export edildi.
// - İlgili component'e export edildi.
// - context type yardımıyla context ilgili component'e atandı.
// - this.context yardımıyla ilgili veriye ulaşıldı.



// 2) Provider ---> Consumer
// - Class component oluşturuldu ve veri state içine koyuldu.
// - Contex'e ait provider ile state'te bulunan veri alındı.
// - Parent child ilişkisi (this.props.children)
// - Veri göndereceğimiz component'e context import edildi.
// - Render içerisinde consumer ile provider'dan gelen veri yakalandı.